    ...
    >
          ...
          <Box>
            {currentTab === 0 && (
              <Box sx={{ display: 'flex', gap: 3, height: 'calc(100vh - 200px)' }}>
                ...
                <Box sx={{ flex: '0 0 calc(80% - 12px)', display: 'flex', flexDirection: 'column', gap: 2 }}>
                ...
                <Box sx={{ flex: '0 0 calc(20% - 12px)' }}>
                  <VoiceRecorder onSendAudio={handleSendAudio} isProcessing={isProcessing} />
                </Box>
              </Box>
            )}

            {currentTab === 1 && (
              <UserProfile user={user} onUpdatePreferences={handleUpdatePreferences} />
            )}
          </Box>
        </Fade>
      </Container>
      ...
      >
        <Alert
          ...
          variant="filled"
          sx={{
            bgcolor: notification.severity === 'success' ? '#18181b' : undefined,
            color: '#ffffff',
            border: '1px solid #27272a',
            borderRadius: 2,
          }}
