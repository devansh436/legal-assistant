...
const { generateWithHistory, formatForVoice } = require('../services/geminiService');
...
router.post('/process-query', async (req, res) => {
  try {
    ...
    console.log('🤖 AI Response generated:', voiceOptimizedResponse.substring(0, 100) + '...');
    ...
    try {
      ...
      if (ttsText.length > 2000) {
        console.log(`⚠️ Response too long (${ttsText.length} chars), truncating...`);
      ...
      console.log(`🔊 Using voice: ${user.preferences.voiceId || 'aura-asteria-en'}`);
